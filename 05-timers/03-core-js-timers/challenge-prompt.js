...
var questionThreePartOne = setTimeout(function(){
    alert("Question 3 Part 1")}, 1000 * 15);


// Create a timer that creates an alert that says "Question 3 part 2" after 16 seconds

var questionThreePartTwo = setTimeout(function() {
    alert("Question 3 Part 2")}, 1000 *16);


console.log("==================== Question 04 ====================");
// Remove the timer from Question 3 part 1
clearTimeout(questionThreePartTwo);
